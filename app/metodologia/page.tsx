...
export default function MetodologiaPage() {
  return (
    <div className="min-h-screen flex flex-col bg-transparent text-[#132339]">
      ...
      {/* Main Content */}
      <main id="metodologia-content" className="flex-1 flex flex-col bg-white">
        {/* Blue Header Section */}
        <div className="bg-gradient-to-br from-[#132339]/90 via-[#0f1d30]/90 to-[#0a1421]/90 backdrop-blur-sm text-white pt-32 pb-12 lg:pt-40">
          <div className="relative z-20 mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl">
              ...
              <h1 className="text-3xl font-extrabold sm:text-4xl lg:text-5xl leading-tight text-white">
                Inmersiona <span className="text-[#c2410c]">Metodología</span>
              </h1>
              <p className="mt-4 text-base sm:text-lg leading-relaxed text-slate-300">
                Nuestras metodologías de auditoría y optimización sobre el terreno. Elige el proceso de inmersión idóneo para entender y agilizar tus operaciones.
              </p>
            </div>
          </div>
        </div>
