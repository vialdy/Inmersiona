...
export default function MetodologiaPage() {
  return (
    <div className="min-h-screen flex flex-col bg-transparent text-[#132339]">
      ...
      {/* Main Content */}
      <main id="metodologia-content" className="flex-1 bg-gradient-to-br from-[#132339]/90 via-[#0f1d30]/90 to-[#0a1421]/90 backdrop-blur-sm text-white pt-32 pb-0 lg:pt-40">
