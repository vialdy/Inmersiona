...
export function DetailedNetworkMap({
  ...
  return (
    <div id="operational-map" className="relative w-full h-auto min-h-[300px] md:h-[640px] lg:h-[640px] flex flex-col justify-between items-center rounded-2xl border border-[#c2410c]/25 bg-white/[0.03] p-6 backdrop-blur-sm shadow-xl shadow-black/25">
