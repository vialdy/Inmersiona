...
const steps = [
  {
    ...
    desc: "Mapeamos en vivo la realidad diaria del usuario final en su puesto de trabajo real.",
    x: 240,
    y: 510
  },
  {
    ...
    desc: "Identificamos y cuantificamos clics innecesarios, datos duplicados y tiempos muertos.",
    x: 315,
    y: 578
  },
  {
    ...
    desc: "Ordenamos mejoras prácticas de alto impacto basadas en retorno de inversión (ROI) operativo.",
    x: 395,
    y: 430
  },
  {
    ...
    desc: "Conectamos CRM, bases de datos y flujos de información para asegurar trazabilidad total.",
    x: 465,
    y: 330
  },
  {
    ...
    desc: "Sincronizamos telefonía, CRM y scoring de leads mediante soluciones lógicas.",
    x: 585,
    y: 225
  },
  {
    ...
    desc: "Medimos la mejora de eficiencia codo con codo con quienes operan el software a diario.",
    x: 720,
    y: 215
  }
];
...
// This guarantees zero abrupt kinks, resulting in a smooth, fluid serpentine road.
const segments = [
...
export function InteractiveNetworkMap() {
  ...
  return (
    ...
    <article
      id="operational-map"
      aria-label="Mapa operativo interactivo de Inmersiona sobre España"
      className="relative flex flex-col justify-between rounded-2xl border border-white/10 bg-white/[0.02] backdrop-blur-sm p-6 sm:p-8 shadow-2xl shadow-black/35 overflow-hidden group"
    ...
    >
      ...
      <div className="flex items-center gap-4 border-b border-white/10 pb-4">
        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-white shadow-md transition-all duration-300 hover:scale-105">
        ...
        <div>
          <h2 className="text-lg font-extrabold text-white leading-tight">Inmersiona</h2>
          <p className="text-base font-bold text-slate-300 mt-0.5">Mapa Operativo</p>
        </div>
      </div>
      ...
      <div className="relative rounded-xl border border-white/10 bg-white/[0.03] backdrop-blur-md p-5 h-auto min-h-[140px] md:h-[140px] overflow-hidden flex flex-col justify-center transition-all duration-300">
        <div className="absolute top-3 right-4 flex items-center gap-1">
          ...
          <span className="text-[9px] font-bold text-slate-300 uppercase tracking-widest">
            {hoveredStep !== null ? "Inspeccionando" : "Mapa Vivo"}
          </span>
        </div>
        <span className="text-[11px] font-black tracking-widest text-[#c2410c] uppercase">
